...
import { SubscriptionModel, TransactionModel } from "./shared/subscription.model";
...
@Component({
    selector: "tracker-subscription",
    moduleId: module.id,
    templateUrl: "./subscription.component.html"
})

export class SubscriptionComponent implements OnInit, AfterContentInit, OnDestroy {
