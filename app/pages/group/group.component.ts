...
import { ViewGroup } from "./shared/group.model";

import { isJson } from "../../core/check-json";
import { Jsonp } from "@angular/http/src/http";

@Component({
    selector: "tracker-group",
    moduleId: module.id,
    templateUrl: "./group.component.html"
})

export class GroupComponent implements OnInit, AfterContentInit, OnDestroy {
    ...
    constructor(private zone: NgZone, private routerExtensions: RouterExtensions, private routeParams: ActivatedRoute,
        private tabsService: TabsService, private groupService: GroupService, private route: ActivatedRoute,
